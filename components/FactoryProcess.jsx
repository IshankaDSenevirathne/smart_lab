		...
		<div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
						...
						<div className="flex-grow border border-t-0 rounded-b">
							<div className="p-5">
								...
								<p className="text-sm text-gray-900">
									...
									gentlemen super mario des lynam alpha trion
									zap rowsdower.
								</p>
							</div>
						</div>
						...
						<div className="flex-grow border border-t-0 rounded-b">
							<div className="p-5">
								...
								<p className="text-sm text-gray-900">
									...
									panties. Heart attack never stopped old Big
									Bear.
								</p>
							</div>
						</div>
					...
					<div className="flex flex-col h-full">
						...
						<div className="flex-grow border border-t-0 rounded-b">
							<div className="p-5">
								...
								<p className="text-sm text-gray-900">
									Bro ipsum dolor sit amet gaper backside
									single track, manny Bike epic clipless.
			...
			<div className="text-center">
				<Link
					...
					hover:bg-red-700 focus:shadow-outline focus:outline-none"
				>
					Learn more
				</Link>
			</div>
